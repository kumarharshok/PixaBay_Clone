...
const PixabayState = (props) => {
    ...
    const api_key = "37841521-1830180ae1bd81b782db51adf"
    ...
    const fecthImageByCategory = async (cat)=> {
  ...
  return (
    <PixabayContext.Provider value={{ imageData, fecthImageByCategory, setQuery }}>
